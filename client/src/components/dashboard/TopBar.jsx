...
export function TopBar() {
  ...
  return (
    <header 
      className="h-16 border-b border-white/5 bg-transparent flex items-center justify-between px-6 shrink-0 z-20 w-full select-none"
    >
      {/* Title */}
      <div>
                  ...
                  reminders.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Dropdown controls action triggers */}
